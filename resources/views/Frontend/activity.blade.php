                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="ratio ratio-64:45">
                            <img src="{{asset('images/'.$activity->image_1)}}" alt="image" class="rounded-4 img-ratio">
                        </div>
                    </div>

                    <div class="swiper-slide">
                        <div class="ratio ratio-64:45">
                            <img src="{{asset('images/'.$activity->image_2)}}" alt="image" class="rounded-4 img-ratio">
                        </div>
                    </div>

                    <div class="swiper-slide">
                        <div class="ratio ratio-64:45">
                            <img src="{{asset('images/'.$activity->image_3)}}" alt="image" class="rounded-4 img-ratio">
                        </div>
                    </div>

                    <div class="swiper-slide">
                        <div class="ratio ratio-64:45">
                            <img src="{{asset('images/'.$activity->image_4)}}" alt="image" class="rounded-4 img-ratio">
                        </div>
                    </div>
            ...
            <div class="row y-gap-30">
                <div class="col-lg-8">
                    <div class="row justify-between items-end">
                        <div class="col-auto">
                            <h1 class="text-26 fw-600">{{$activity->name}}</h1>
                                    ...
                                    <div class="row x-gap-10 items-center">
                                        <div class="col-auto">
                                            <div class="d-flex x-gap-5 items-center">
                                                ...
                                                <div class="text-15 text-light-1">{{$activity->destination->name}},{{$activity->destination->district}}</div>
                                            </div>
                                        </div>
