                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-10">
                                                        <div class="text-15 lh-12 fw-500 js-search-option-target">
                                                            {{$hotels->first()->destination->name}}</div>
                            ...
                            <div class="row x-gap-20 y-gap-20">
                                ...
                                <div class="col-md">
                                    <h3 class="text-18 lh-16 fw-500">
                                        {{$hotel->title}}<br class="lg:d-none"> Hotel, {{$hotel->destination->name}}
                                    ...
                                    <div class="row x-gap-10 y-gap-10 items-center pt-10">
                                        <div class="col-auto">
                                            <p class="text-14">{{$hotel->destination->name}},{{$hotel->destination->district}}</p>
                                        </div>
                                ...
                                <div class="col-md-auto text-right md:text-left">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="text-22 lh-12 fw-600 mt-5">${{$hotel->price}}</div>
                                        <div class="text-14 text-light-1 mt-5">+US$828 taxes and charges</div>


                                        <a href="{{route('front.viewHotel',$hotel->slug)}}" class="button -md -dark-1 bg-blue-1 text-white mt-24">
